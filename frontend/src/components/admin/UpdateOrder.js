        ...
        <Fragment>
          <div className="row d-flex justify-content-around">
            <div className="col-12 col-lg-8 mt-5 order-details">
              <h1 className="my-5">Order # {orderDetail.orderUId}</h1>
...
//               </p>
//               {/* <p>
//                 <b>Amount:</b> &#8377;{discountDetails.finalAmountAfterDiscount ? discountDetails.finalAmountAfterDiscount : totalPrice}
//               </p> */}
//                  <p>
//                     <b>Amount:</b> &#8377;
//                     {typeof discountDetails?.finalAmountAfterDiscount === "number" &&
//                     !isNaN(discountDetails.finalAmountAfterDiscount) &&
//                     discountDetails.finalAmountAfterDiscount !== 0
